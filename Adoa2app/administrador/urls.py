...
from Adoa2app.administrador.views import index_administrador, usuarios_index, usuarios_edit, perfiles_edit, perfiles_index,menu_index, menu_edit,menu_tipo_index,menu_tipo_edit
